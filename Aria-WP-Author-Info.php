...
// Get link to the author archive page
        ...
        if ( ! empty( $display_name ) )
            ...
            $author_details = '<p style="direction: rtl" class="author_name">درباره نویسنده پست : ' . $display_name . '</p>';
...
// Author avatar and bio
        ...
        $author_details .= '<p class="author_links"><a href="'. $user_posts .'">نمایش تمام پست های  ' . $display_name . '</a>';
